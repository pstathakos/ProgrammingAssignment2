...
## The cacheSolve function determines is the inverse value of the matrix has already been cached
## and returns it if is has been. If not it calcualtes the inverse and stores it in the cache.
